...
if (import.meta.env.DEV && !hasSupabase) {
  console.warn(
    '[Allowance Tracker] Supabase env not loaded. Check: (1) .env has VITE_SUPABASE_URL and VITE_SUPABASE_ANON_KEY, (2) no spaces around =, (3) dev server was restarted after editing .env.'
  )
}
